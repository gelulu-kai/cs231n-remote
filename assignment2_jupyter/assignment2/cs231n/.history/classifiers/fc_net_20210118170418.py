...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dx2, dw2, db2 = affine_backward(dscores, ar2_cache)
...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        self.dtype = dtype
        self.params = {}
        self.use_batchnorm = normalization != None
    ...
    def loss(self, X, y=None):
        ...
        dx, dw, db = affine_backward(hout, ar_cache[self.num_layers])
        ...
        for idx in range(self.num_layers - 1):
          ...
          if self.use_batchnorm:
            ...
            dx, dw, db = affine_relu_backward(hout, ar_cache[lay])
